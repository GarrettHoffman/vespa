...
ExtractKeywordsTest::RunTest(int testno, bool verify)
{
    ...
    {
        // Simple term query
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "foobar"));
    ...
    case 1:
    {
        // multi term query
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "foobar"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "foo"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "bar"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_OR, 3));
    ...
    case 2:
    {
        ...
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "foo"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "bar"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_PHRASE, 3, "index"));
    ...
    case 3:
    {
        ...
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "xyzzy"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "xyz"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_PHRASE, 2, "index"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "foobar"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "foo"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "bar"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_PHRASE, 3, "index"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "baz"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "zog"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_AND, 3));
    ...
    case 4:
    {
        ...
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "foobar"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "foo"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_AND, 2));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_TERM, "bar"));
        stack.Push(new search::SimpleQueryStackItem(search::SimpleQueryStackItem::ITEM_PHRASE, 2, "index"));
